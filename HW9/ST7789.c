...
// drawChar function
void drawChar(const unsigned short x, const unsigned short y, const unsigned short color, unsigned char letter)
{
    letter = letter-0x20;
    int i;
    int j;
...
// drawString function
void drawString(const unsigned short x, const unsigned short y, unsigned short color, char* m)
{
    int len = strlen(m);
    int i;
    for(i=0; i<len; i++)
    {
        drawChar(x+6*i,y,color,m[i]);
    }
}

// drawProgressBar function
void drawProgressBar(const unsigned short x, const unsigned short y, const unsigned short progress, const unsigned short length)
{
    int i;
    int j;
    for (i=0; i<length; i++){
